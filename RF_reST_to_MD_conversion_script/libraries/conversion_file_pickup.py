...
def get_all_file_names(resources_subfolder_name:str) -> list[str]:   
    source_directory = os.path.join(os.get_exec_path(), "resources", resources_subfolder_name)
...
def get_single_file_name(resources_subfolder_name:str, file_name:str) -> str:  
    return os.path.join(os.get_exec_path(), "resources", resources_subfolder_name, file_name) 