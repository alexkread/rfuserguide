...
def get_file_contents_split_by_lines(file_full_name:str) -> str:   
...
def locate_file_content_text_block_instances(file_full_name:str, 
block_start:str, block_end:str="") -> list:
    file_lines = get_file_contents_split_by_lines(file_full_name)
    located_blocks = [] 
    ...
    for i, line in enumerate(file_lines, 1):
        if _line_matches_sought_start(line, block_start):
            ...
            #located_blocks[located_block_count][1] ="end: "+str(i)
            search_block_end = False
